...
export default function Scanner() {
  ...
  //entering defaulter data into db
  ...
  //   axios.post("http://192.168.48.36:5001/mark-defaulter", data)
  //     .then((response) => {
  ...
  const handleMarkDefaulter = () => {
    ...
    axios.get(`http://192.168.253.106:5003/check-scanned-today/${rolldb}`)
      .then((response) => {
        if (response.data.scannedToday) {
          ...
          axios.post("http://192.168.253.106:5003/mark-defaulter", data)
            .then((response) => {
              console.log(response.data);
              // Show success message
              Alert.alert('Success', 'Student marked as defaulter successfully');
  ...
  const handleBarCodeScanned = ({ type, data }) => {
    ...
    axios.get(`http://192.168.253.106:5003/student/${data}`)
      .then((response) => {
  ...
  function handlecheck() {
    ...
    axios.post("http://192.168.253.106:5003/register", userdata).then((res) => console.log(res.data)).catch((e) => console.log(e))
  ...
  function handlerollNo(e) {
    ...
    axios.get(`http://192.168.253.106:5003/student/${rollvar}`)
      .then((response) => {
        // Check if the response contains data
        if (response.data) {
          // If the roll number exists, update the name state with the corresponding name
