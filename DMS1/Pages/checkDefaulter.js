...
//     try {
//       const response = await axios.get('http://192.168.61.36:5001/defaulterFetch');
...
//     try {
//       console.log("filter");
//       const response = await axios.get(`http://192.168.61.36:5001/defaulterFetch?fromDate=${fromDate}&toDate=${toDate}`);
//       setDefaulterData(response.data);
//     } catch (error) {
...
export default function DefaulterList() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://192.168.253.106:5003/defaulterFetch');
      setDefaulterData(response.data);
    } catch (error) {
      console.error('Error fetching data:', error);
    }
  ...
  const handleFilter = async () => {
    try {
      ...
      const response = await axios.get(`http://192.168.253.106:5003/defaulterFetch?fromDate=${fromDate}&toDate=${toDate}&department=${departmentDD}`);
      setDefaulterData(response.data);
