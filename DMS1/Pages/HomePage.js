  ...
  return (
    <View style={styles.container}>
      ...
      {/* <View style={styles.buttonContainer}>
          ...
          <Button
            title="Admin Login"
            onPress={() => navigation.navigate('Admin')} // Navigate to Admin login page
            color="#48B4FF"
            
          />
          <Button
            title="Staff Login"
            onPress={() => navigation.navigate('Staff')} // Navigate to Staff login page
            color="#48B4FF"
          />
      </View> */}
...
// // Remove the navigator name from the top (header)
// HomePage.options = {
//   headerShown: false,
// };
