...
const mongoUrl="mongodb+srv://2025vcetitb19:abdul@cluster0.mpuh8ba.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
//     const oldUser = await Student.findOne({RollNo:roll})
//     if(oldUser){
//         return res.send({data:"User already exists"})
//     }
//     try {
...
  }
  ...
  //   try {
  //     // Fetch defaulter data from the database
...
//       // Extract fromDate, toDate, and department from query parameters
//       const { fromDate, toDate, department } = req.query;
...
//       // Fetch defaulter data based on the query
//       const defaulters = await DefaulterTable.find(query);
